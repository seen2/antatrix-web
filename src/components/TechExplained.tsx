  ...
  return (
    <div className='container' >
      <div className="d-flex justify-content-center shadow-lg p-3 mb-5 bg-body-tertiary rounded border-start border-end" >
        <h2 className='display-3 text-center text-info'>{props.title || "Web Development"}</h2>
      </div>
      <br />
      ...
      <div className='rounded ' style={{height:50}}>
        <u className='text-muted '  >All rights reserved @2023 Antatrix</u>
